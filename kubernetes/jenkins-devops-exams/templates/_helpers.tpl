...
*/}}
{{- define "jenkins-devops-exams.chart" -}}
...
helm.sh/chart: {{ include "jenkins-devops-exams.chart" . }}
...
{{- default (include "jenkins-devops-exams.fullname" .) .Values.serviceAccount.name }}
{{- else }}
